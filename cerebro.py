"""
cerebro.py — El clasificador personalizado de emails de Marco
=============================================================
...
Responsabilidades de este módulo, y solo estas:
  - el CRITERIO de Marco (qué es importante y qué es ruido)
...
# ─────────────────────────────────────────────────────────────────────────
# EL CRITERIO DE Marco — el corazón del producto. Editar esto es "entrenar"
# al agente. No hace falta tocar nada más.
# ─────────────────────────────────────────────────────────────────────────

CRITERIO = """Eres el asistente personal de correo de Marco, estudiante de 3º de
...
para Marco (una beca dudosa, un evento que quizá encaje), márcalo como IMPORTANTE.
...
if __name__ == "__main__":
    EJEMPLOS = [
        ...
        ("profesor.garcia@ufv.es", "Sobre tu proyecto de la asignatura",
         "Marco, he visto tu entrega y quería comentarte un par de cosas. ¿Puedes pasarte el jueves?"),
